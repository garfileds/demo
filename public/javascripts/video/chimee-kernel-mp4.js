(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["chimeeKernelMp4"] = factory();
	else
		root["chimeeKernelMp4"] = factory();
})(this, function() {
...
var Mp4decode = function (_CustEvent) {
	_inherits(Mp4decode, _CustEvent);

	function Mp4decode() {
		_classCallCheck(this, Mp4decode);

		var _this = _possibleConstructorReturn(this, (Mp4decode.__proto__ || Object.getPrototypeOf(Mp4decode)).call(this));

		_this.mp4box = new _core.MP4Box();
		_this.bindEvent();
		_this.index = 0;
		return _this;
	}

	_createClass(Mp4decode, [{
		key: 'bindEvent',
...
var _chimeeHelper = __webpack_require__(7);

var _mseController = __webpack_require__(9);

var _mseController2 = _interopRequireDefault(_mseController);

var _transmuxer = __webpack_require__(10);
...
var Mp4 = function (_CustEvent) {
  ...
  function Mp4(videodom, config) {
    ...
    var _this2 = _possibleConstructorReturn(this, (Mp4.__proto__ || Object.getPrototypeOf(Mp4)).call(this));
...
var _mp4decode = __webpack_require__(4);

var _mp4decode2 = _interopRequireDefault(_mp4decode);

var _webworkifyWebpack = __webpack_require__(16);
...
var Transmuxer = function (_CustEvent) {
  ...
  function Transmuxer(mediaSource, config) {
    ...
    if (_this.config.webWorker) {
      ...
      _this.w = (0, _webworkifyWebpack2.default)(/*require.resolve*/(17));
  ...
  _createClass(Transmuxer, [{
    ...
    */
    ...
    value: function arrivalDataCallback(data, byteStart, keyframePoint) {
      ...
      var consumed = 0;
      if (!this.CPU) {
        this.CPU = new _mp4decode2.default();
